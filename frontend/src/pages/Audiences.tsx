      ...
      {isLoading ? (
        ...
        <div className="mt-6">
          <EmptyState
            ...
            description="Pre-built audience segments will appear here once they are created by admins."
          />
        </div>
      ) : (
        <div className="mt-6 grid gap-4 sm:grid-cols-2">
          {data.map((a) => (
            <Card key={a.id} className="flex flex-col transition-all hover:shadow-md">
              ...
              <CardContent className="flex flex-1 flex-col pt-0">
                ...
                <div className="mt-4 flex justify-end border-t border-border pt-3">
                  <Button
                    ...
                    className="transition-colors hover:bg-accent-soft hover:text-accent-foreground"
                  >
                    Plan a campaign
